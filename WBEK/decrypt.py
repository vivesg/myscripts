...
# Provided AS-IS no warranty use by your responsibility
    ...
    if Name is not None:
        if Name.upper() == VMNAME.upper():
            ...
            if URL is not None:
                ...
                key = result.key
                with open("WRAPBEK_VM_" + VMNAME + "_drive_" + VolumeLetter + "_" + time + FILENAME, 'wb') as f:
                    f.write(key)
                print("===============================================")
                print("WRAP BEK File Key generated name: " + "WRAPBEK_VM_" + VMNAME + "_drive_" + VolumeLetter + "_" + time + FILENAME)
                print("VM: " + VMNAME)
                ...
                with open("BEK_VM_" + VMNAME + "_drive_" + VolumeLetter + "_" + time + FILENAME, 'wb') as fw:
                    fw.write(rawbytes)
                print("===============================================")
                print("BEK File Key generated name: " + "BEK_VM_" + VMNAME + "_drive_" + VolumeLetter + "_" + time + FILENAME)
                print("VM: " + VMNAME)
                print("Volume Letter: " + VolumeLetter)
